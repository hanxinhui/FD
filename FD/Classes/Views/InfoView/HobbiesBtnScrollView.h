...
@protocol HobbiesBtnScrollViewDelegate <NSObject>

- (void)HobbiesSelectBtnTag:(NSInteger)tag;//当前选择

@end

@interface HobbiesBtnScrollView : UIScrollView <UIScrollViewDelegate>
{
    NSArray *nameArray;
...
@property (nonatomic, assign) id<HobbiesBtnScrollViewDelegate>          btnDelegate;//
