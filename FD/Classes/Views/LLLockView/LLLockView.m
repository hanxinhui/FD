...
#define kLLLineColor [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.8] // 线条色白
...
- (void)endPosition
{
    ...
    for (int i=0; i < selectedButtonArray.count; i++) {
        ...
        string= [string stringByAppendingFormat:@"%ld",(long)strbutton.tag-kLLBaseCircleNumber];
    }
