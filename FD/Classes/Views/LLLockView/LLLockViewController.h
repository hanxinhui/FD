...
@interface LLLockViewController : BaseViewController <LLLockDelegate>

@property (nonatomic) LLLockViewType nLockViewType; // 此窗口的类型
@property (nonatomic ,strong) UIButton      *otherLoginBtn; // 其他登录
@property (nonatomic ,strong) UIButton      *fogBtn; // 忘记登录
@property (nonatomic ,strong) UILabel       *showFLab; // 提示1
@property (nonatomic ,strong) UILabel      *showSLab; // 提示2
