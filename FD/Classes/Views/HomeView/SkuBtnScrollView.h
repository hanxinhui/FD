...
@protocol SkuBtnScrollViewDelegate <NSObject>

- (void)selectBtnTag:(id)sender;//当前选择

@end

@interface SkuBtnScrollView : UIScrollView <UIScrollViewDelegate>
{
    NSArray *nameArray;
...
@property (nonatomic, assign) id<SkuBtnScrollViewDelegate>          btnDelegate;//
