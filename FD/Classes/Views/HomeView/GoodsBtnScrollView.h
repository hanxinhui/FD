...
@protocol GoodsBtnScrollViewDelegate <NSObject>

- (void)selectBtnTag:(id)sender;//当前选择

@end

@interface GoodsBtnScrollView : UIScrollView <UIScrollViewDelegate>
{
    NSArray *nameArray;
...
@property (nonatomic, assign) id<GoodsBtnScrollViewDelegate>          btnDelegate;//
