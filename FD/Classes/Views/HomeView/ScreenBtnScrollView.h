...
@protocol ScreenBtnScrollViewDelegate <NSObject>

- (void)ScreenSelectBtnTag:(NSInteger)tag;//当前选择

@end

@interface ScreenBtnScrollView : UIScrollView <UIScrollViewDelegate>
{
    NSArray *nameArray;
...
@property (nonatomic, assign) id<ScreenBtnScrollViewDelegate>          btnDelegate;//
