...
#define kIdentifier @"SnatchAdViewCellIdentifier"
#define kPageH 20
@interface SnatchAdView() <UIScrollViewDelegate>
...
- (void)addScrollView {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        SnatchAdsNode *node = self.currentImages[i];
        imageView.backgroundColor = [UIColor clearColor];

        [imageView sd_setImageWithURL:[NSURL URLWithString:node.src] placeholderImage:nil];
