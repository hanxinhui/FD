...
@protocol SelectBtnScrollViewDelegate <NSObject>

- (void)selectBtnTag:(id)sender;//当前选择

@end

@interface SelectBtnScrollView : UIScrollView <UIScrollViewDelegate>
{
    NSArray *nameArray;
...
@property (nonatomic, assign) id<SelectBtnScrollViewDelegate>          btnDelegate;//
