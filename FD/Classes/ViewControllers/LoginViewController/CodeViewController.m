...
//    self.view.alpha = 0.8;
    [self initNavBar];
    setHeight = setHeight + NVARBAR_HIGHT + 30;
    ...
    NSString *cocc = [NSString stringWithFormat:@"您的验证序号是:%@",_codeID];
    _codeTextField.placeholder = cocc;
...
//    _codeTextField.clearButtonMode = UITextFieldViewModeWhileEditing;
    ...
    _timeLab = [[UILabel alloc] initWithFrame:CGRectMake(iPhoneWidth - 100, setHeight,80, 40)];
...
- (void)reqGetCode{
    ...
    [dict setObject:_phoneNum forKey:@"username"];
...
//            _codeTextField.text = [info objectForKey:@"verify"];
        ...
        case REQ_VERIFY:{
            ...
            passWordViewController.phoneNum = _phoneNum;
