//
//  CountersignPayViewController.h
//  FD
//
...
typedef enum {
    WelfareCountersignStyle,// 福利抢宝
    GroupCountersignStyle, // 群抢宝
} HttpCountersignStyle;


@interface CountersignPayViewController : BaseViewController<ShowSurePayViewDelegate>
{
...
@property (nonatomic ,strong) ShowSurePayView *showView;// 展示界面
...
@property (nonatomic) HttpCountersignStyle       countersignStyle;// 请求类型
