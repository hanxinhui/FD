//
//  AnyTimeBuySearchViewController.m
//  FD
//
...
@interface AnyTimeBuySearchViewController ()



@end

@implementation AnyTimeBuySearchViewController
...
-(void)didSelectRowAtIndexPath:(NSIndexPath *)indexPath node:(id)node
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[_listDataArr objectAtIndex:tag] forKey:SEARCH_TASK_KEY];
