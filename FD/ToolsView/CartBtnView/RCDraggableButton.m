...
//    [self.layer setCornerRadius:self.frame.size.height / 2];
    ...
    // 背景图片
    UIImageView *bgImgView = [[UIImageView alloc] initWithFrame:CGRectMake(5, 5, 40, 40)];
    bgImgView.backgroundColor = [UIColor clearColor];
    [self addSubview:bgImgView];
    [bgImgView setImage:[UIImage imageNamed:@"Public_Cart.png"]];

    // 背景图片2
    UIImageView *sbgImgView = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width - 20, 0, 20, 20)];
    sbgImgView.backgroundColor = [UIColor clearColor];
    [self addSubview:sbgImgView];
    [sbgImgView setImage:[UIImage imageNamed:@"Public_Cart_tips.png"]];

    
    // 显示个数
    _numLab = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width - 20, 0, 20, 20)];
