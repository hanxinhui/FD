...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _selectionIndicatorBar.backgroundColor = UIColorWithRGB(252, 91, 55, 1);
...
- (UIButton *)selectionListButtonWithTitle:(NSString *)buttonTitle {
    ...
    [button setTitleColor:UIColorWithRGB(66, 66, 66, 1) forState:UIControlStateNormal];
    [button setTitleColor:UIColorWithRGB(252, 91, 55, 1) forState:UIControlStateSelected];
