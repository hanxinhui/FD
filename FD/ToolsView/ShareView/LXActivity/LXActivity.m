...
#define ACTIONSHEET_BACKGROUNDCOLOR             [UIColor colorWithRed:255.00f/255.00f green:255.00f/255.00f blue:255.00f/255.00f alpha:1.0]
#define ACTIONSHEET_HEADCOLOR             [UIColor colorWithRed:246.00f/255.00f green:247.00f/255.00f blue:248.00f/255.00f alpha:1.0]
...
#define SHAREBUTTONTITLE_FONT                   [UIFont boldSystemFontOfSize:10]
...
#define SHAREBUTTON_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width - 200 ) / 5
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        50
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width - 200 ) / 5
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle shareButtonTitles:(NSArray *)shareButtonTitlesArray withShareButtonImagesName:(NSArray *)shareButtonImagesNameArray
{
    ...
    UIImageView *headImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 50)];
    headImgView.backgroundColor = ACTIONSHEET_HEADCOLOR;
    [self.backGroundView addSubview:headImgView];
    
    UIButton *closeBtn = [[UIButton alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 50, 10, 30, 30)];
    closeBtn.backgroundColor = [UIColor clearColor];
    [closeBtn setImage:[UIImage imageNamed:@"Public_CloseBtn.png"] forState:UIControlStateNormal];
    [closeBtn addTarget:self action:@selector(tappedCancel) forControlEvents:UIControlEventTouchUpInside];
...
- (UILabel *)creatShareLabelWithColumn:(int)column andLine:(int)line
{
    ...
    shareLabel.textColor = [UIColor colorWithRed:135.00f/255.00f green:136.00f/255.00f blue:136.00f/255.00f alpha:1.0];
    return shareLabel;
}

- (UILabel *)creatTitleLabelWith:(NSString *)title
{
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, TITLE_WIDTH, 50)];
