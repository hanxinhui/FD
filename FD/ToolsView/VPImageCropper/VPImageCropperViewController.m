...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, iPhoneWidth, iPhoneHeight)];
...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, iPhoneHeight - 50.0f, 100, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(iPhoneWidth - 100.0f, iPhoneHeight - 50.0f, 100, 50)];
