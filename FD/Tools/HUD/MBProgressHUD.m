...
//                              constrainedToSize:CGSizeMake(maxWidth, MAXFLOAT) lineBreakMode:label.lineBreakMode];
    CGSize labelSize;
    if (IOS7) {
        NSDictionary *attribute = @{NSFontAttributeName: label.font};
        labelSize = [label.text  boundingRectWithSize:CGSizeMake(maxWidth, MAXFLOAT)  options:
...
//                          constrainedToSize:CGSizeMake(maxWidth, MAXFLOAT) lineBreakMode:label.lineBreakMode];
    ...
    if (IOS7) {
        ...
        detailsLabelSize = [detailsLabel.text  boundingRectWithSize:maxSize  options:
                     NSStringDrawingTruncatesLastVisibleLine |
                     NSStringDrawingUsesLineFragmentOrigin |
                     NSStringDrawingUsesFontLeading
                                           attributes:attribute context:nil].size;
