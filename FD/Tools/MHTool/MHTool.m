...
+(NSData *)encodeBase64:(NSData *)data{
    return [MHCode encodeBase64:data];
}
...
+(NSData *)decodeBase64:(NSData *)data{
    return [MHCode decodeBase64:data];
}
...
+(NSData *)decodeBase64String:(NSString *)string{
    return [MHCode decodeBase64String:string];
}
...
+ (NSString *)encodeDES:(NSString *)string{
    return [MHCode encodeDES:string];
}
...
+ (NSString *)decodeDES:(NSString *)string{
    return [MHCode decodeDES:string];
}
...
+(NSString*)dateToString:(NSString *)formatter timeInterval:(NSTimeInterval)timeInterval{
    return [MHCommonTool dateToString:formatter timeInterval:timeInterval];
}
...
+(NSString*)dateToString:(NSString *)formatter date:(NSDate *)date{
    return [MHCommonTool dateToString:(NSString *)formatter date:(NSDate *)date];
}
...
+(NSString *)getCurrentTime:(NSString *)formatter{
    return [MHCommonTool getCurrentTime:formatter];
}
...
+(NSString*)convertDateFormatter:(NSString*)sourceFormatter 
    ...
    return [MHCommonTool convertDateFormatter:(NSString*)sourceFormatter 
                              targetFormatter:(NSString*)targetFormatter  
                                   dateString:(NSString*)dateString];
}
...
+(NSDate *)stringToDate:(NSString *)formatter dateString:(NSString *)dateString{
    return [MHCommonTool stringToDate:(NSString *)formatter dateString:(NSString *)dateString];
}
...
+(NSString*)dateToString:(NSString *)formatter secs:(NSTimeInterval)secs{
    return [MHCommonTool dateToString:formatter secs:secs];
}
...
+(NSString *)charToUTF8String:(const char *)charData{
    return [MHCommonTool charToUTF8String:(const char *)charData];
}
...
+(NSString *)stringToMD5Value:(NSString *)string{
    return [MHCommonTool stringToMD5Value:(NSString *)string];
}
...
+(int)randNumber:(int)max{
    return [MHCommonTool randNumber:(int)max];
}
...
+(NSString *)replaceStringToString:(NSString *)needReplaceStr
    ...
    return [MHCommonTool replaceStringToString:(NSString *)needReplaceStr
                                 replaceString:(NSString *)replaceString
                               toReplaceString:(NSString *)toReplaceString];
}
...
+(NSString *)trimString:(NSString *)buf{
    return [MHCommonTool trimString:(NSString *)buf];
}
...
+(NSString *)dataToUTF8String:(NSData *)data{
    return [MHCommonTool dataToUTF8String:(NSData *)data];
}
...
+ (CGFloat)toRadians:(CGFloat)degree{
    return [MHCommonTool toRadians:(CGFloat)degree];
}

//弧度转角度  
+ (CGFloat)toDegrees:(CGFloat)radian{
    return [MHCommonTool toDegrees:(CGFloat)radian];
}
...
+(NSString *)changeDataToEncodinString:(NSData *)data encodin:(NSStringEncoding )encodin{
    return [MHCommonTool changeDataToEncodinString:(NSData *)data encodin:(NSStringEncoding )encodin];
}
...
+(void)alertWithTitle:(NSString *)title 
    ...
    return [MHCommonTool alertWithTitle:(NSString *)title 
                                Message:(NSString *)message 
                               delegate:(id)delegate 
                           cancelButton:(NSString *)cancelButton
                            otherButton:(NSString *)otherButton];
...
+ (BOOL)stringIsValidEmail:(NSString *)checkString{
    return [MHCommonTool stringIsValidEmail:(NSString *)checkString];
}
...
+(UIImage *)getScreenShot:(UIView *)view{
    return [MHCommonTool getScreenShot:view];
}
...
+(void)saveDataToUserDefaults:(NSString *)key value:(NSString *)vallue{
    [MHCommonTool saveDataToUserDefaults:key value:vallue];
}
...
+(id)getDataFromUserDefaults:(NSString *)key{
    return [MHCommonTool getDataFromUserDefaults:key];
}
 ...
 **/
+(NSString *)createUUID{
    return [MHCommonTool createUUID];
}
...
+(NSString *)getResourcesFile:(NSString *)fileName{
    return [MHFile getResourcesFile:(NSString *)fileName];
}
...
+(NSString *)getLocalFilePath:(NSString *)fileName{
    return [MHFile getLocalFilePath:(NSString *)fileName];
}
...
+(NSString *)getCacheFilePath:(NSString *)fileName{
    return [MHFile getCacheFilePath:(NSString *)fileName];
}
...
+(NSString *)createDir:(NSString *)dirName{
    return [MHFile createDir:(NSString *)dirName];
}
...
+(void)createDirWithDirPath:(NSString *)path{
    return [MHFile createDirWithDirPath:(NSString *)path];
}
...
+(BOOL)isExistsFileInDoc:(NSString *)fileName{
    return [MHFile isExistsFileInDoc:(NSString *)fileName];
}
...
+(BOOL)isExistsFileInRescource:(NSString *)fileName{
    return [MHFile isExistsFileInRescource:(NSString *)fileName];
}
...
+(NSString *)getFileNameByPath:(NSString *)filepath{
    return [MHFile getFileNameByPath:(NSString *)filepath];
}
...
+(void)removeDirByPath:(NSString *)filepath{
    return [MHFile removeDirByPath:(NSString *)filepath];
}
...
+(void)removeDirByName:(NSString *)fileName{
    return [MHFile removeDirByName:(NSString *)fileName];
}
...
+(NSArray *)getAllFileByName:(NSString *)path{
    return [MHFile getAllFileByName:(NSString *)path];
}
...
+(BOOL)copyFile:(NSString *)srcPath dstPath:(NSString *)dstPath{
    return [MHFile copyFile:srcPath dstPath:dstPath];
}
...
+ (NSString *)currentLocale{
    return [MHSystemTool currentLocale];
}
...
+ (NSString *)currentLanguage{
    return [MHSystemTool currentLanguage];
}
 ...
 **/
+ (NSArray *)allLanguage{
    return [MHSystemTool allLanguage];
}
...
+ (NSString *)deviceModel{
    return [MHSystemTool deviceModel];
}
...
+ (NSDate *)stringDate:(NSString *)formatter string:(NSString *)string{
    return [MHSystemTool stringDate:(NSString *)formatter string:(NSString *)string];
}
 ...
 **/
+ (BOOL)deviceCamera{
    return [MHSystemTool deviceCamera];
}
...
+ (NSString *)deivceVersion{
    return [MHSystemTool deivceVersion];
}
 ...
 **/
+ (NSString *)deivceName{
    return [MHSystemTool deivceName];
}
...
+ (NSString *)deviceBattery{
    return [MHSystemTool deviceBattery];
}
...
+ (BOOL)deviceDefinition{
    return [MHSystemTool deviceDefinition];
}
...
+(BOOL)locationService{
    return [MHSystemTool locationService];
}
...
+(double)programVersion{
    return [MHSystemTool programVersion];
}
 ...
 **/
+(NSString *)macAddress{
    return [MHDeviceTool macAddress];
}
