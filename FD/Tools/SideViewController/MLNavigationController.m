...
{
    if (_pan == gestureRecognizer && !_canDragBack) {
        return NO;
    }
    return YES;
}
...
{
    stateBarHidden = hidden;
    [self setNeedsStatusBarAppearanceUpdate];
}

//-(UIStatusBarStyle)preferredStatusBarStyle{
//    return (stateBarLight)?UIStatusBarStyleLightContent:UIStatusBarStyleLightContent;
//}
- (BOOL)prefersStatusBarHidden
{
    return stateBarHidden;
}
